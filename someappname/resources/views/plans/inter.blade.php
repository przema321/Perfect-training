        ...
        <div class="col">
            <div class="collapse multi-collapse" id="multiCollapseExample2">
                <div class="card card-body">
                    <h3>Trening:</h3>
                    <ul>
                        <li>Martwy ciąg 8 powtórzeń</li>
                        <li>A2 Wyciskanie hantli jednorącz pro 8 powtórzeń</li>
                        <li>A3 Abwheel 10 powtórzeń</li>
                        <li style="list-style-type: none;">Odpocznij 90 sekund między ćwiczeniami. Wykonaj je po 4
                            razy.
                        </li>
                    </ul>
                    <ul>
                        ...
                        <li style="list-style-type: none;">Odpocznij 90 sekund między ćwiczeniami. Wykonaj je po 3
                            razy.
                        </li>
                    </ul>
                    <ul>
                        ...
                        <li style="list-style-type: none;">Odpocznij 60 sekund między ćwiczeniami. Wykonaj je po 3
                            razy.
                        </li>
                    </ul>
                    <ul>
            ...
            <div class="collapse multi-collapse" id="multiCollapseExample3">
                <div class="card card-body">
                    ...
                    <ul>
                        ...
                        <li>Każde ćwiczenie wykonaj raz.</li>
                    </ul>
